...
public class Vehicle_In_Activity extends Activity implements AsyncTaskListener {
    ...
    Button park, back, getphonenumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getphonenumber = (Button) findViewById(R.id.getphonenumber);
        ...
        getphonenumber.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //TODO
                //Check whether the car number is entered
                if (!carnumber_.getText().toString().isEmpty() && carnumber_.length() >= 4) {


                    String URL_ = EConstants.Production_URL + "getMobileNo_JSON/" + carnumber_.getText().toString().trim();
                    Log.e("URL is:", URL_);
                    new Generic_Async_Post(Vehicle_In_Activity.this, Vehicle_In_Activity.this, TaskType.GET_PHONE_NUMBER).execute("getMobileNo_JSON", URL_);
                            ...
                            if (AppStatus.getInstance(Vehicle_In_Activity.this).isOnline()) {
                                ...
                                if (estimated_Time > 0) {
                                    ...
                                    switch (message) {
                                        ...
                                        case "4":
                                            message.equalsIgnoreCase("4");
                                            main_message = "Upto 8 Hours";
                                            break;

                                        case "5":
                                            message.equalsIgnoreCase("5");
                                            main_message = "Upto 10 Hours";
                                            break;

                                        case "6":
                                            message.equalsIgnoreCase("6");
                                            main_message = "Upto 12 Hours";
                                            break;

                                        case "7":
                                            message.equalsIgnoreCase("7");
                                            main_message = "Upto 24 Hours";
                                            break;

                                        case "8":
                                            message.equalsIgnoreCase("8");
                                            main_message = "Upto 1 Month";
                                            break;

                                        case "9":
                                            message.equalsIgnoreCase("9");
                                            main_message = "Upto 1 Hour";
                                            break;


                                        default:
                                            main_message = "Something Bad Happened";
                                            break;
    ...
    public void onTaskCompleted(String result, TaskType taskType) {
        ...
        } else if (taskType == TaskType.GET_PHONE_NUMBER) {
            phonenumber_.setText("");
            String Result_to_Show = null;
            //Toast.makeText(Vehicle_In_Activity.this,result,Toast.LENGTH_LONG).show();
            Result_to_Show = Vehicle_In_Out_Json.GetPhoneNumber(result);

            if(Result_to_Show.length()==10){
                phonenumber_.setText(Result_to_Show);
            }else{
                Custom_Dialog CD = new Custom_Dialog();
                CD.showDialog(Vehicle_In_Activity.this,Result_to_Show);
            }
